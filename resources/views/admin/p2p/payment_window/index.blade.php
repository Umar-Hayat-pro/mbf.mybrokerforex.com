                ...
                <form method="POST" action="{{route('admin.p2p.payment.window.save')}}">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control create-multiple-field" name="minute" value="{{ old('minute') }}" required>
                        </div>
                    </div>
                    ...
                    $(".modal-body").append(`
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control create-multiple-field" name="multiple_payment_window[]" required>

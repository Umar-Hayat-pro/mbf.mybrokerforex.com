...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('admin.setting.system.configuration.update')}}" method="post">
                @csrf
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Metamask Login')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, users can Login/Register via metamask')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="metamask_login" @if($general->metamask_login) checked @endif>
                            </div>
                        </li>
                    </ul>
                </div>

                                            ...
                                            @if ($val->value)
                                                            ...
                                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="imageModalLabel{{$loop->index}}">Image Preview
                                                                        </h5>
                                                                    ...
                                                                    <div class="modal-body text-center">
                                                                        <img src="{{ asset(getFilePath('verify') . '/' . $val->value) }}"
                                                                            alt="Large Image Preview" class="img-fluid modal-image zoomable-image"
                                                                            id="zoomImage{{$loop->index}}" style="cursor: zoom-in;" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                @elseif(pathinfo($val->value, PATHINFO_EXTENSION) == 'pdf')
                                                    <div class="mt-2">
                                                        ...
                                                        <div class="modal fade" id="pdfModal{{$loop->index}}" tabindex="-1" aria-hidden="true">
                    ...
                    <form action="{{ route('admin.deposit.comment', $deposit->id) }}" method="POST" class="mb-4">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="comment" id="comment" class="form-control" rows="3"
                                placeholder="@lang('Write your comment...')" required></textarea>
                        </div>

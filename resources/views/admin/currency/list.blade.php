                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($type == Status::CRYPTO_CURRENCY)
                                                {{ $general->cur_sym }}{{ showAmount(@$currency->marketData->price ?? @$currency->rate ) }}
                                            @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" step="any" name="price" value="{{ old('price') }}" required>
                                    ...
                                    @if ($type == Status::CRYPTO_CURRENCY)
                                        <div class="form-group col-lg-12">
                                            ...
                                            <input type="checkbox" data-width="100%" data-height="40px" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('YES')"

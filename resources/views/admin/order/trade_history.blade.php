                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ showAmount($trade->rate) }} {{ @$trade->order->pair->market->currency->symbol }}
                                </td>
                                <td> {{ showAmount($trade->amount) }} {{ @$trade->order->pair->coin->symbol }}</td>
                            </tr>
                            @empty
                            <tr>
...
<div class="d-flex flex-wrap gap-2 justify-content-between">
    ...
    <form>
        <div class="input-group test--dark">

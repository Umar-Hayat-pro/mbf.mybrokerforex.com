          ...
          <div class="table-responsive--sm table-responsive">
            <table class="table table--light style--two custom-data-table">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="button--group">
                        ...
                        @endif
                        {{-- Delete button --}}
                        {{-- <form action="{{ route('admin.form_ib.destroy_by_user_id', $ibAccount['id']) }}" method="POST" style="display:inline;">
                          @csrf
                          @method('DELETE')
                ...
                @empty
                  <tr>
                    <td colspan="5" class="text-center">@lang('No Pending  accounts found')</td>
                  </tr>
                @endforelse
              </tbody>
            </table>

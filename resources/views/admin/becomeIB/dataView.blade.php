...
<div class="row">
  <div class="col-lg-12">
    ...
    @endif
          ...
          <form method="POST" action="{{ route('admin.become_ib.createAccount', $formData->user_id) }}"
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="email" value="{{ $formData->email ?? 'N/A' }}" readonly>
                </div>
              </div>
            </div>

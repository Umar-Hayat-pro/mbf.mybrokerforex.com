      ...
      <div class="transection h-100">
          ...
          @if ($user->referrer)
              <div class="col-md-12">
                  <div class="card">
                      <div class="card-body">
                          <h4>@lang('User was referred by') <span class="text--base">{{ @$user->referrer->fullname }}</span></h4>
                      </div>
                  </div>
              </div>
          @endif
              ...
              <div class="col-md-12">
                  <div class="card">
                      <div class="card-header">
                          <h5 class="text-start">@lang('Users Referred By ') <span class="twxt--base">{{ @$user->fullname}}</span></h5>
                      </div>
                      <div class="card-body">
                  ...
                  <div class="card">
                      <div class="card-body p-5">
                          <div class="empty-thumb text-center">
                              <img src="{{ asset('assets/images/extra_images/empty.png') }}" alt="@lang('No data found')" />

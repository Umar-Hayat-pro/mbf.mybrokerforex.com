                            ...
                            <p class="success-message">
                                @if (@$trade->buyer_id == $user->id)
                                    ...
                                    <span class="text--success">
                                        {{ showAmount($trade->asset_amount) . ' ' . $trade->ad->asset->symbol }}
                                    </span>
                                    @lang('with ') <span class="text--danger">
                                        {{ showAmount($trade->fiat_amount) . ' ' . $trade->ad->fiat->symbol }}
                                    </span>
                                @else
                                    @lang('Sell')
                            ...
                            <div class="order-details__info-wrapper">
                                <div class="order-details__info">
                                    ...
                                    <div class="order-details__info-item">
                                        ...
                                        <h6 class="amount-count mb-0">
                                            {{ showAmount(@$trade->fiat_amount) }} {{ __(@$trade->ad->fiat->symbol) }}
                                        </h6>
                                    </div>
                                    <div class="order-details__info-item">
                                        <span class="title">
                                        ...
                                        <h6 class="amount-count mb-0">
                                            {{ showAmount(@$trade->asset_amount) }} {{ __(@$trade->ad->asset->symbol) }}
                                        </h6>
                                    </div>
                                    <div class="order-details__info-item">
                                        <span class="title"> @lang('Rate')</span>
                                        <h6 class="amount-count mb-0">
                                            {{ showAmount(@$trade->ad->price) }} {{ __(@$trade->ad->fiat->symbol) }} /

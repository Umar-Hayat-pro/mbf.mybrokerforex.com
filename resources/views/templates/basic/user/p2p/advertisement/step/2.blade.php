...
<div class="row">
    ...
    <div class="form-group col-lg-12">
        ...
        <select class="form-control form--control form-select" name="payment_window" required>
    ...
    <div class="form-group col-lg-12">
        ...
        <select class="form-control form--control form-select" name="price_type" required>

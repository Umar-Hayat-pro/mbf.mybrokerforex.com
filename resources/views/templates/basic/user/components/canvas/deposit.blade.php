...
@endphp
<div class="offcanvas offcanvas-end p-5 bg-white text-dark" tabindex="-1" id="deposit-canvas" aria-labelledby="offcanvasLabel">
        ...
        <form action="{{ route('user.deposit.insert') }}" method="post"
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="number" step="any" class="form--control2 form-control" name="amount" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control form--control2 form-select" name="gateway" required>
                    @if (@$singleCurrency)
            ...
            <div class="form-group">
                ...
                <select class="form-control form--control2 form-select" name="wallet_type" required>

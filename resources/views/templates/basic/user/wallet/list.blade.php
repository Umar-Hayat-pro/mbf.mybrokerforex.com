                    ...
                    <tbody>
                        @forelse($wallets as $wallet)
                            <tr>
                                ...
                                <td>{{ __(@$wallet->currency->sign) }}{{ showAmount(@$wallet->balance) }}</td>
                                <td>{{ __(@$wallet->currency->sign) }}{{ showAmount(@$wallet->in_order) }} </td>
                                <td>{{ __(@$wallet->currency->sign) }}{{ showAmount(@$wallet->total_balance) }} </td>
                                <td>

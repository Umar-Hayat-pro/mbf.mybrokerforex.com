...
@section('content')
    ...
    @if (checkWalletConfiguration($walletType, 'transfer_other_user') || checkWalletConfiguration($walletType, 'transfer_other_wallet'))
        <div class="offcanvas offcanvas-end bg-white text-dark" tabindex="-1" id="transfer-offcanvas" aria-labelledby="offcanvasLabel">
            ...
            <div class="offcanvas-body">
                <ul class="nav nav-pills custom--tab bg-white" id="pills-tab" role="tablist">

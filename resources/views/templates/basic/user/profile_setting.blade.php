                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form--control2" name="state"
                                                    value="{{ @$user->address->state }}" @if ($user->profile_request !== 1)
                                                    readonly @endif>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form--control2" name="city"
                                                    value="{{ @$user->address->city }}" @if ($user->profile_request !== 1)
                                                    readonly @endif>
                                            </div>
                                        </div>
                                        <div class="col-12"> {{-- Address 100% --}}
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form--control2" name="address"
                                                    value="{{ @$user->address->address }}" @if ($user->profile_request !== 1)
                                                    readonly @endif>
                                            </div>
                                        </div>
                                        <div class="col-lg-6"> {{-- Zip Code 50% --}}
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form--control2" name="zip"
                                                    value="{{ @$user->address->zip }}" @if ($user->profile_request !== 1)
                                                    readonly @endif>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {{-- Explanation: Sending country_code and country to controller, Showing
                                            Selected country based on the user->country_code and comparing it with the $key
                                            that is how we are showing that bug fixed. --}}
                                            <div class="form-group">
                                                ...
                                                @else
                                                    <input type="text" class="form-control form--control2"
                                                        value="{{ @$user->address->country }}" readonly>
                                                    <small
                                                        class="text-muted">@lang('Country can be changed after profile update request is approved')</small>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="col-12">

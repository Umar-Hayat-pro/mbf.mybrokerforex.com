                ...
                <form  action="{{route('ticket.store')}}"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" class="form--control2" name="subject" value="{{old('subject')}}"  required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label class="form-label">@lang('Priority')</label>
                            <select name="priority" class="form-control form--control2" required>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="message" id="inputMessage" rows="6" class="form-control form--control2" required>{{old('message')}}</textarea>
                        </div>
                        <div class="text-end ">

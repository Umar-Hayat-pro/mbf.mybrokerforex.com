        ...
        <div>
            ...
            <p class="trading-header-number">
                <span
                    ...
                    {{ showAmount(@$pair->marketData->price) }}
                </span>
            </p>
        </div>
        <div>
            ...
            <p class="trading-header-number market-last-price-{{ @$pair->marketData->id }} ">
                {{ showAmount(@$pair->marketData->last_price) }}</p>
        </div>
        <div>
            ...
            <p class="trading-header__number ">
                <span
                    ...
                    {{ showAmount(@$pair->marketData->percent_change_1h, 2) }}%
                </span>
            </p>
        </div>
        <div>
            ...
            <p class="trading-header__number {{ @$pair->marketData->html_classes->percent_change_24h }}">
                {{ showAmount(@$pair->marketData->percent_change_24h, 2) }}%
            </p>
        </div>
        <div>
            <span class="text--base fs-12">@lang('Marketcap')</span>
            <p class="trading-header__number"> {{ showAmount(@$pair->marketData->market_cap) }} </p>
        </div>
    </div>
</div>

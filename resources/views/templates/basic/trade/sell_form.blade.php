...
<form action="{{ route('user.order.save', @$pair->symbol) }}" class="buy-sell-form buy-sell @if(@$meta->screen=='small') buy-sell-two @endif sel--form"  method="POST">
    @csrf

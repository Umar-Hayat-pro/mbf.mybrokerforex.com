@php
    $sellerWallet = App\Models\Wallet::funding()
        ->where('user_id', auth()->id())
        ->where('currency_id', $ad->asset_id)
        ->first();
@endphp
            ...
            <div class="p2p-order-info-left section-bg">
                    ...
                    <div class="order-details__info">
                        <div class="order-details__info-item">
                            ...
                            <h6 class="amount-count mb-0">
                                {{ showAmount($ad->price) }} {{ __(@$ad->fiat->symbol) }}
                            </h6>
                        </div>
                        <div class="order-details__info-item">
                            <span class="title">
                        ...
                        <div class="order-details__info-item">
                            ...
                            <h6 class="amount-count mb-0">
                                {{ showAmount($coinWalletBalance) }} {{ __(@$ad->asset->symbol) }}
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="p2p-trams">
                    <div class="p2p-trams-content">
                        ...
                        <div>
                            @php echo $ad->terms_of_trade @endphp
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-5">
            <form class="p2p-order-info-left trade-rquest-form">
                ...
                <div class="form-group">
                    <label class="form--label">@lang('I want to sell')</label>
                    ...
                    <span class="mt-1  text--warning fs-11">
                        @lang('Available'): {{ showAmount($sellerWallet->balance) }} {{ __(@$ad->asset->symbol) }}
                    </span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="form--label">@lang('Receiving Payment Method')</label>
                ...
                <div class="p2p-button d-flex flex-wrap gap-2">
                    ...
                    <button class="btn flex-fill btn--danger" type="submit">

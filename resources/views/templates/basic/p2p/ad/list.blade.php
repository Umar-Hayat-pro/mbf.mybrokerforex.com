    ...
    <tr>
                    ...
                    <h6 class="customer__name">
                        ...
                        @if ($ad->user->kv)
                            <span class="verified-profile">
                                <img data-bs-toogle="tooltip" title="@lang('KYC Verified')" src="{{ asset('assets/images/extra_images/kyc.png') }}">
                            </span>
                        @endif
                    </h6>
        ...
        <td>
            <div class="price fs-14 skeleton text--base">
                <span class="amount">{{ showAmount($ad->price) }}</span>

...
class SocialLogin
{
    ...
    public function __construct($provider, $isApi = false)
    {
        $this->provider = $provider;
        $this->configuration($isApi);
    }
    ...
    private function configuration($isApi)
    {
        $provider      = $this->provider;
        $configuration = gs()->socialite_credentials->$provider;

        $provider    = $isApi && $provider == 'linkedin' ? 'linkedin-openid' : $provider;

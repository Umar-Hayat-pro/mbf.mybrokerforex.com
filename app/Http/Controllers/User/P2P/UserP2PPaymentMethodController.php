...
class UserP2PPaymentMethodController extends Controller
{
    public function list()
    {
        ...
        return view($this->activeTemplate . 'user.p2p.payment_method.index', compact('pageTitle', 'paymentMethods'));
    }
    ...
    public function create()
    {
        ...
        return view($this->activeTemplate . 'user.p2p.payment_method.create', compact('pageTitle', 'methods'));
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->activeTemplate . 'user.p2p.payment_method.create', compact('pageTitle', 'methods', 'paymentMethod'));
    }

...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view($this->activeTemplate . 'user.p2p.index', compact('pageTitle', 'widget', 'trades', 'user'));
    }
    ...
    public function feedbackList()
    {
        ...
        $pageTitle = "P2P Center";
        return view($this->activeTemplate . 'user.p2p.feedback', compact('pageTitle', 'feedbacks'));
    }
}

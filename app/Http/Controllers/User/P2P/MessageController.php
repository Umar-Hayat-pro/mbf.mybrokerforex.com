...
class MessageController extends Controller
{
    ...
    public function save(Request $request, $tradeId)
    {
        ...
        $senderHtml   = view($this->activeTemplate . 'user.p2p.trade.single_message', ['message' => $message, 'direction' => 'sender'])->render();
        $receiverHtml = view($this->activeTemplate . 'user.p2p.trade.single_message', ['message' => $message, 'direction' => 'receiver'])->render();

...
class AdvertisementController extends Controller
{
    public function index()
    {
        ...
        return view($this->activeTemplate . 'user.p2p.advertisement.index', compact('pageTitle', 'ads'));
    }
    ...
    public function create($id = 0)
    {
        ...
        return view($this->activeTemplate . 'user.p2p.advertisement.create', compact('pageTitle', 'step', 'ad'));
    }

...
class LanguageController extends Controller
{
    ...
    public function langStore(Request $request)
    {
        $request->validate([
            ...
            'flag' => ['required', 'image', new FileTypeValidate(['jpg', 'jpeg', 'png'])],
        ]);
        ...
        if ($request->hasFile('flag')) {
            $language->flag = fileUploader($request->flag, getFilePath('language'), getFileSize('language'));
        }
    ...
    public function langUpdate(Request $request, $id)
    {
        $request->validate([
            'name' => 'required',
            'flag' => ['nullable', 'image', new FileTypeValidate(['jpg', 'jpeg', 'png'])],
        ]);
        ...
        if ($request->hasFile('flag')) {
            $language->flag= fileUploader($request->flag, getFilePath('language'), getFileSize('language'),$language->flag);
        }

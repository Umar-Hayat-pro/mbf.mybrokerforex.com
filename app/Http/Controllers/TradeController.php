...
class TradeController extends Controller
{
    public function trade($symbol = null)
    {
        ...
        $pageTitle = showAmount($pair->marketData->price) . ' | ' . $pair->symbol;

        return view($this->activeTemplate . 'trade.index', compact('pageTitle', 'pair', 'markets', 'coinWallet', 'marketCurrencyWallet', 'gateways'));
    }
